...
public class HbaseDemo {
    ...
    private static void test1(String tableName) {
        try {
              createTable(tableName, new String[] { "information", "contact" });
              User user = new User("001", "lvaolin", "123456", "man", "20", "13355550021", "1232821@csdn.com");
    ...
    public static Connection getHbaseConnection() throws IOException {
        if (connection==null) {
            ...
            //configuration.set("hbase.master", "172.16.30.12:60000");
